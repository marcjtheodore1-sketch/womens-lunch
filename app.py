...
def get_default_confirmation_message():
    """Return a simple message for admin settings - actual messages are generated by generate_confirmation_message"""
    return "Confirmation messages are automatically generated with booking details."
